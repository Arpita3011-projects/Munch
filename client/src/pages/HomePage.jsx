  ...
  return (
    <PageContainer>
      <div className="flex flex-col items-center justify-center py-20 text-center">
        ...
        <h1 className="text-2xl font-display font-bold text-brand-charcoal mb-2">
          Welcome to Munch
        </h1>
        <p className="text-brand-charcoal/60 max-w-sm">
          Browse the menu, customize your order, and enjoy The Yard Milkshake Bar from anywhere.
        </p>
      </div>
    </PageContainer>
  );
