  ...
  const handleGoogleRegister = async () => {
    ...
    try {
      const mockPayload = {
        ...
        email: email ? email.toLowerCase() : (name || 'user') + '@gmail.com',
  ...
  return (
    <PageContainer>
      <div className="max-w-sm mx-auto pt-8">
        ...
        <button type="button" onClick={handleGoogleRegister} disabled={isLoading} className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-brand-charcoal/20 rounded-full text-sm font-medium text-brand-charcoal hover:bg-brand-charcoal/5 transition-colors min-h-[44px] disabled:opacity-50 disabled:cursor-not-allowed">
